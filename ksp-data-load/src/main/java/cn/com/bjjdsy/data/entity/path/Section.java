package cn.com.bjjdsy.data.entity.path;
...
public class Section {
	 ...
	 * @param line Track this belongs to
	 ...
	 */
	public Section(Station start, Station end, Line line, int ID, int direction, int dist, int time,
			double impedance) {
		this.setStart(start);
		this.setEnd(end);
		this.setTrack(line);
